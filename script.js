...
var plappActiveHTML = '<div id="pbl-wrapper"> <div id="pblPrompt"> <h1>Hey there!</h1> <h4>We have something that we think you might be interested in.</h4> <h3>Two Paths Ahead</h3> <p>You could keep going through these lesson pages, front to back, and then doing the assessment at the end.</p><h4>OR</h4> <p>You can choose to go a different way. We will give you a project first, and then you can use the lesson pages as resources for your project.</p></br> <h3>Which Would You Like To Do?</h3> <p>Both choices are worth 100 points AND the same level of difficulty.</p><ul> <li>Choosing the normal lesson will close this and let you continue on your way.</li><li>Choosing the different way will give you more details.</li></ul> </br> <button id="pbl-no">The Normal Lesson</button><div class="divider"/><button id="pbl-yes">The Different Lesson</button> </div><div id="pblResponse"> <h1>Awesome!</h1> <p>Thanks for being willing to try something different.</p><h3>Getting Started</h3> <p>Go ahead and put your first name and FLVS email in the form below and we will contact your teacher for you. They will give you the details on what you will need to do.</p><form id="ajax-contact" method="post" action="mailer.php"> Your first name:<br><input id="PBLusername" type="text" name="username"><br>Your FLVS email:<br><input id="PBLemail" type="email" name="email"><br><div id="form-messages"></div><p>We want you to keep moving so while you are waiting to hear back from your teacher, we have some tasks to get started on.</p><hr> <h3>Starting Tasks- You will want to write these down.</h3> <p>In this project you will create an travel agent itinerary (emaze.com) or a video (knovio.com) to evaluate three Mesoamerican societies.</p><p>You will start by learning about all 3 cultures. It would be best for you to take notes. </br> </br> You are looking for the elements of SPRITE (Social, Political, Religion, Intellectual, Technological, Economic) and will incorporate these in your final project. </br></br>Be sure your final submission has 10 total examples from any of these 6 categories.</p><ul> <li>Step 1: Go to page 6 of lesson 3.04 and complete the Review and Practice Activity. What did these three groups have in common?</li></br><li>Step 2: Go to page 3 of lesson 3.04 and review the infographic for the Inca. Ask yourself the following questions: <ol> <li>What elements of SPRITE do you see in this civilization?</li><li>What do you like MOST about this civilization? What would make you want to visit or move here?</li><li>What did you like LEAST about this civilization? What would make you hesitant about visiting or living in this civilization?</li></ol> <ul> <li>Answer the same questions for the infographics on page 4 and page 5.</li></ul> </li></ul> </br> <button id="pblButton">SUBMIT NAME AND CLOSE THIS SCREEN</button> </form> </div></div>';
